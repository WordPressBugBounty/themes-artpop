...
function artpop_theme_customizer( $wp_customize ) {
	...
	$wp_customize->add_section( 'home_featured_posts', array(
		...
		'description' => __( 'Display a Featured Posts area at the top of the Homepage.', 'artpop' ),
		'priority'    => 7,
	) );
	...
	$wp_customize->add_control( new Artpop_Customize_Radio_Image(
		...
		'header_layout',
			...
			'choices' => array(
				'header-1' => array(
					'img'  => get_template_directory_uri() . '/inc/images/header-01.svg',
				),
				'header-2' => array(
					'img'  => get_template_directory_uri() . '/inc/images/header-02.svg',
				),
			),
	...
	// Site Logo
	$wp_customize->add_setting( 'site_logo_mobile_size', array(
		'default'           => artpop_defaults( 'site_logo_mobile_size' ),
		'sanitize_callback' => 'absint',
	) );
	$wp_customize->add_control( 'site_logo_mobile_size', array(
		'label'       => __( 'Logo Max Width (Mobile)', 'artpop' ),
	...
	$wp_customize->add_setting( 'site_logo_hide_tagline_on_mobile', array(
		'default'           => artpop_defaults( 'site_logo_hide_tagline_on_mobile' ),
		'sanitize_callback' => 'artpop_sanitize_checkbox',
	) );
	$wp_customize->add_control( 'site_logo_hide_tagline_on_mobile', array(
		'label'    => __( 'Hide Tagline on Mobile', 'artpop' ),
		'section'  => 'site_logo',
		'type'     => 'checkbox',
		'priority' => 5,
	) );
...
function artpop_customize_preview_js() {
	wp_enqueue_script( 'artpop-customizer-js', get_template_directory_uri() . '/inc/js/customize-preview.js', array( 'customize-preview' ), '20191205', true );
}
...
function artpop_customizer_style() {
	wp_enqueue_style('artpop-customizer-styles', get_template_directory_uri() . '/inc/css/customize-style.css', array(), '20200827' );
}
